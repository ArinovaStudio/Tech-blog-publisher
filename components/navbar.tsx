...
import { AuthModal } from './signup/auth-modal';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between h-16 gap-4">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              <span className="font-bold text-foreground text-sm sm:text-base">AlgorithmXlr8.io</span>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
              ...
              <button 
                ...
                className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full bg-gray-100 text-gray-900 hover:bg-gray-200 transition-colors text-sm font-medium"
              >
                Get Started
          ...
          {isOpen && (
            <div className="lg:hidden border-t border-border/50 py-4 space-y-3">
              ...
              <button 
                ...
                className="w-full bg-gray-600 sm:hidden px-4 py-2 mt-2 rounded-lg  text-primary-foreground hover:bg-gray-700 transition-colors text-sm font-medium"
              >
                Get Started
              </button>
            </div>
